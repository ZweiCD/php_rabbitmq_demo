...
$channel->queue_bind($q_name, $ex_name, '*.*.rabbit'); //将队列绑定交换机和路由键
$channel->queue_bind($q_name, $ex_name, 'lazy.#'); //将队列绑定交换机和路由键

echo " [*] Waiting for messages. To exit press CTRL+C\n";

$callback = function ($msg) {
    echo ' [x] Received routing_key:', $msg->delivery_info['routing_key'], ' ', $msg->body, " from queue:q_topic_1\n";
